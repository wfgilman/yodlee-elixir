defmodule Yodlee.Transaction do
  ...
  defstruct id: nil, account_id: nil, container: nil, amount: nil, interest: nil,
            principal: nil, date: nil, status: nil, base_type: nil
  ...
  """
  @spec list(user_session, String.t, String.t | integer) :: {:ok, [Yodlee.Transaction.t]} | {:error, error}
