defmodule Yodlee.ProviderAccount do
  ...
  defstruct id: nil, aggregation_source: nil, created_date: nil, is_manual: nil,
            last_updated: nil, provider_id: nil, refresh_info: nil
  ...
  """
  @spec get(user_session, String.t | integer) :: {:ok, Yodlee.ProviderAccount.t} | {:error, error}
  ...
  """
  @spec delete(user_session, String.t | integer) :: {:ok, Yodlee.ProviderAccount.t} | {:error, error}
